...
import com.madmobiledevs.ajooba.Model.Products;
import com.madmobiledevs.ajooba.Model.orders;
import com.madmobiledevs.ajooba.Prevalent.Prevalent;
import com.madmobiledevs.ajooba.ViewHolder.OrderViewHolder;
import com.madmobiledevs.ajooba.ViewHolder.ProductViewHolder;
        ...
        FirebaseRecyclerAdapter<orders, OrderViewHolder> adapter =
                new FirebaseRecyclerAdapter<orders, OrderViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull final OrderViewHolder orderViewHolder, int i, @NonNull final orders orders) {
                        ...
                        orderViewHolder.timeSlot_TxtVw.setText(orders.getTimeSlot());
                        orderViewHolder.order_Id_TxtVw.setText("AJ-"+orders.getOrderId());
